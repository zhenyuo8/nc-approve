define(["./common"], function (c) {
    ...
    var Re = {
        ...
        getComponentData: function (layoutDetail) {
            ...
            // 子表数据处理
            if(layoutDetail[0].taskbill&&layoutDetail[0].taskbill.body&&layoutDetail[0].taskbill.body[0]){
                jsonContent={};
        ...
        processContent: function (obj) {
            ...
            if(obj[contentKey] instanceof Object){
                ...
                }else if(obj[contentKey].hasOwnProperty('dV')){
                    data.content=(obj[contentKey].dV[1]-0).toFixed(1);
                }else{
                    data.content='';
                }
            }else{
