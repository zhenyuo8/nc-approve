                ...
                ajaxConfig = {
                    ...
                    success: function (listData) {
                        ...
                        if(listData.data&&listData instanceof Array){
                            ...
                            var aa=[{"attachstructlist":[{"downflag":"1","fileid":"1002V6100000001KQI33","filename":"恩施门店-打印机发票.png","filesize":"968KB"}],"count":"1","des":"获取附件列表成功","flag":"0"}];
                            var list=aa[0].attachstructlist||[],listdata=[];
                            list.forEach(function(item,index){
                                var typeArr=item.filename.split('.');
                                listdata.push({
                                    name:item.filename,
