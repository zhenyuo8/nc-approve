...
define(["utils", "base"], function (utils, baseClass) {
    var Component = function (config) {
        ...
        var cancelBtn = $("<div style='width:" + this.cancelBtnWidth + "px;height:" + inputHeight + "px;font-size:" + utils.fontSize(16) + "px' class='yy-sv-cancel displayflex yy-jc-center yy-ai-center'>"+utils.getLanguageText('cancel')+"</div>");
