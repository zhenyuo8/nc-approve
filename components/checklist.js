define(["utils", "base"], function (utils, baseClass) {
    ...
    var Component = function (config) {
        ...
        this.CancelBtn = $("<div  class='yy-checklist-btn'>"+utils.getLanguageText('cancel')+"</div>");
        this.OkBtn = $("<div class='yy-checklist-btn yy-checklist-okbtn'>"+utils.getLanguageText('confirm')+"</div>");
