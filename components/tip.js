...
define(["utils"],function(utils){
  ...
  var Tip = function(outWrapper,style){
    var _this = this;
    outWrapper = outWrapper||$(document.body);
    if(style){
        this.tipWrapper = $("<div class='yy-tip displayflex jc-center ai-center displaynone' style='position:absolute;left: 80px;transform: rotate(90deg)'></div>");
    }else{
