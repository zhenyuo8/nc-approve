...
define(["utils","base"],function(utils,baseClass){
    var Component = function(config){
        ...
        var title = config.title||"",placeholder=utils.getLanguageText('example');
        this.input = $("<textarea placeholder='"+placeholder+"' style='width: 94%;margin-left: 3%;height: 100px;font-size: 13px;padding: 6px;outline: none;resize: none;border: 1px solid #e6e6e6;-webkit-tap-highlight-color: transparent;tap-highlight-color:transparent;-webkit-appearance: none;appearance: none'></textarea>");
        this.titleDom = $("<div class='yy-dialog-title' style='font-weight: bold;color: #333;font-size: 16px'>"+title+"</div>");
        dialogBody.append(this.titleDom).append(this.input);
