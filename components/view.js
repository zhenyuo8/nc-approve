  ...
  function gtIOS6() {
    ...
    Component.prototype._initPullToRefreshDom = function(){
      ...
      this.pullArrowIcon =  $("<i style='font-size:"+iconSize+"px' class='yy-pull-arrow'></i>");
        this.pullMesLabel =  $("<span style='font-size:"+fontSize+"px' class='yy-pull-meslabel'>"+utils.getLanguageText('pullToRefresh')+"</span>");
    ...
    Component.prototype._initLoadMoreDom = function(){
      ...
      this.loadMoreLabel =  $("<span style='font-size:"+fontSize+"px' class='yy-pull-meslabel'>"+utils.getLanguageText('loading')+"</span>");
    ...
    Component.prototype._initLoadMoreErrorDom = function(){
      ...
      this.loadErrorLabel =  $("<span style='font-size:"+fontSize+"px' class='yy-pull-meslabel'>"+utils.getLanguageText('NetworkError')+"</span>");
      var reloadLabel = $("<span style='font-size:"+fontSize+"px' class='yy-loadmore-reload-babel'>"+utils.getLanguageText('reLoading')+"</span>");
    ...
    Component.prototype._initLoadFirstErrorDom = function(){
      ...
      this.loadFirstErrorLabel =  $("<span style='font-size:"+fontSize+"px' class='yy-pull-meslabel'>"+utils.getLanguageText('networkerrorLoading')+"</span>");
      ...
      if(this.pluginPullToRefreshMethod){
        ...
        this.$el.bind("touchstart",function(e){
          ...
          this.$el.bind("scroll",function (e) {
              if(_this.pageview.refs.searchInput&&!_this.pageview.refs.searchInput.$el.find('input').val()){
                  _this.pageview.refs.searchInput.$el.addClass("yy-sv-input-hide");
                  $(_this.pageview.refs.searchInput.clearBtn[0]).addClass("displaynone");
              }
          });
        this.$el.bind("touchmove",function(e){
          ...
          if(diff>0){
            ...
            if(scrollTop <=0){
              ...
              if(_this.pageview.refs.searchInput){
    ...
    Component.prototype.setPullLoadingState = function(){
      ...
      _this.pullMesLabel.html(utils.getLanguageText('loading'));
    ...
    Component.prototype.setLoadFirstError = function(){
      ...
      if(this.LoadFirstErrorWrapper){
        ...
        if(!this.loadErrorWrapWhenNoPullRefrsh){
          ...
          var loadMoreerrorIcon = $("<i style='font-size:"+iconSize+"px' class='yy-icommon yy-loadmore-erroricon'></i>");
          this.loadErrorLabelWhenNoPullRefrsh =  $("<span style='font-size:"+fontSize+"px' class='yy-pull-meslabel'>"+utils.getLanguageText('NetworkError')+"</span>");
          var reloadLabel = $("<span style='font-size:"+fontSize+"px' class='yy-loadmore-reload-babel'>"+utils.getLanguageText('reLoading')+"</span>");
          reloadLabel.bind("click",function(){
            _this.pluginLoadMoreErrorToReloadMethod &&_this.pluginLoadMoreErrorToReloadMethod.call(_this.pageview.plugin,_this,{});
          });
    ...
    Component.prototype.setCanLoadMore = function(arg){
      ...
      this.loadMoreLabel.html(utils.getLanguageText('loading'));
    ...
    Component.prototype.setHasLoadDone = function(){
      ...
      this.canLoadMore = false;
      this.loadMoreLabel.html(utils.getLanguageText('showDone'));
      this.LoadFirstErrorWrapper&&this.LoadFirstErrorWrapper.addClass("displaynone");
