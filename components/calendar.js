...
function(utils, baseClass, swiper) {
  ...
  Component.prototype.createDayWraper = function() {
    ...
    var bar = $("<div style='height:" + this.labelBarHeight + "px' class='yy-calendar-bar'><div " + barItemStyle + " class='yy-c-bar-item'>"+utils.getLanguageText('Sunday')+"</div><div " + barItemStyle + " class='yy-c-bar-item'>"+utils.getLanguageText('Monday')+"</div><div " + barItemStyle + " class='yy-c-bar-item'>"+utils.getLanguageText('TuesDay')+"</div><div " + barItemStyle + " class='yy-c-bar-item'>"+utils.getLanguageText('Wednesday')+"</div><div " + barItemStyle + " class='yy-c-bar-item'>"+utils.getLanguageText('Thursday')+"</div><div " + barItemStyle + " class='yy-c-bar-item'>"+utils.getLanguageText('Friday')+"</div><div " + barItemStyle + " class='yy-c-bar-item'>"+utils.getLanguageText('Saturday')+"</div></div>");
  ...
  Component.prototype.triggerChange = function() {
    ...
    this.monthLabel.html((curDateInfo.month ));
