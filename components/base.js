...
define(["utils", "tip"], function (utils, Tip) {
    ...
    Component.prototype.showTip = function (config) {
        if(config.horizontal){
            this.Tip = new Tip(this.$el,config.horizontal);
        }else{
    ...
    Component.prototype.showLoading = function (config) {
        ...
        if (!this.$$loadingWrapper) {
            ...
            if(config.horizontal){
                wrapper=$("<div class='yy-loading-wrapper yy-fd-column displayflex yy-jc-center yy-ai-center yy-horizontal-loading'>" + this.loaderHtml + "</div>");
            }
