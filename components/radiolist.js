define(["utils", "base"], function (utils, baseClass) {
    ...
    var Component = function (config) {
        ...
        var titleWrapper = $("<div style='height:" + labelHeight + "px;font-size:" + utils.fontSize(14) + "px;line-height:" + labelHeight + "px' class='yy-rl-title-wrapper'>" + (config.title || utils.getLanguageText('pleaseSelect')) + "</div>");
    ...
    Component.prototype._getPrimaryValue = function (data) {
        ...
        Component.prototype.itemClick = function (e) {
            ...
            if (dataKey) {
                ...
                if (this.selectedValue[0] && this.selectedValue[0].selectionId === item.itemData.selectionId) {
                    if (item) {
                        this.selectedValue = [];
    ...
    Component.prototype.initLoadErrorDom = function () {
        ...
        var loadErrorLabel = $("<span style='font-size:" + fontSize + "px' class='yy-pull-meslabel'>"+utils.getLanguageText('NetworkError')+"</span>");
