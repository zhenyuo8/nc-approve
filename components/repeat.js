define(["utils", "base"], function (utils, baseClass) {
    var RepeatItem = function (config) {
        ...
        if(config.root&&(config.root[0]==="item_select_icon"||config.root[0]==="checkbox_select_icon")){
            this.$el.addClass('only_for_select');
        }
        this.$el.bind("click", function (e) {
            if (_this.parent.status === "edit") {
                return;
            }
            _this.parent._itemClick(_this,e);
        });
    ...
    Component.prototype._itemClick = function (itemInstance,e) {
        ...
        if (this.pageview.plugin) {
            ...
            method && method.call(this.pageview.plugin, itemInstance, {index: itemInstance.$el.index(),e:e});
        }
